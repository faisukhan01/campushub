...
function getNavigationForRole(role: UserRole): NavigationItem[] {
  ...
  const roleNav: Record<UserRole, NavigationItem[]> = {
    SuperAdmin: [
      ...
      { id: "audit-log", label: "Audit Log", icon: "ScrollText", href: "audit-log" },
    ...
    Teacher: [
      ...
      { id: "question-bank", label: "Question Bank", icon: "Database", href: "question-bank" },
    ...
    Student: [
      ...
      { id: "live-chat", label: "Live Chat", icon: "MessageCircle", href: "live-chat" },
