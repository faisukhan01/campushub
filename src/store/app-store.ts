...
function getNavigationForRole(role: UserRole): NavigationItem[] {
  ...
  const roleNav: Record<UserRole, NavigationItem[]> = {
    ...
    BranchAdmin: [
      ...baseNav,
      { id: "school-classes", label: "Class Management", icon: "Layers", href: "school-classes" },
      { id: "students", label: "Students", icon: "GraduationCap", href: "students" },
      { id: "teachers", label: "Teachers", icon: "Users", href: "teachers" },
      { id: "courses", label: "Subjects & Courses", icon: "BookOpen", href: "courses" },
    ...
    Teacher: [
      ...baseNav,
      { id: "teacher-classes", label: "My Classes", icon: "BookOpen", href: "teacher-classes" },
